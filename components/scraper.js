...
https://www.grubhub.com/search?orderMethod=delivery&locationMode=DELIVERY&pageSize=20&latitude=38.85446548&longitude=-77.32913209&facet=open_now:true&hideHateos&facetSet=umamiV3
var Search = function Search(where) {
  this._where = where;
...
Search.prototype.getRestaurantIds = function(opts, cb) {
  ...
  var url = "https://www.grubhub.com/search?orderMethod=delivery&locationMode=DELIVERY&pageSize=20&latitude=38.85446548&longitude=-77.32913209&facet=open_now:true&hideHateos&facetSet=umamiV3"
  fetch(url)
  .then(res => res.blob())
  .then(res => {
